                    ...
                    <div className="flex flex-col gap-0.5 mt-1 pt-1 border-t border-gray-100">
                      ...
                      <div className="flex items-baseline gap-2">
                        ...
                        <span className="text-indigo-600 text-sm font-semibold whitespace-nowrap">
                          ...
                          <span className="text-gray-400 font-normal ml-1.5 text-xs">end {new Date(drawdownDate).toLocaleDateString(language === "sv" ? "sv-SE" : "en-GB", { month: "short", year: "numeric" })}</span>
                        </span>
                      </div>
                      <div className="flex items-baseline gap-2">
                        ...
                        <span className="text-indigo-600 text-sm font-semibold whitespace-nowrap">
                          ...
                          <span className="text-gray-400 font-normal ml-1.5 text-xs">+{growthRate}%/yr · end {new Date(drawdownDate).toLocaleDateString(language === "sv" ? "sv-SE" : "en-GB", { month: "short", year: "numeric" })}</span>
                        </span>
                      </div>
                      <div className="flex items-baseline gap-2">
                        ...
                        <span className="text-indigo-600 text-sm font-semibold whitespace-nowrap">
                          ...
                          <span className="text-gray-400 font-normal ml-1.5 text-xs">+{growthRate}% −{inflationRate}% infl. · end {new Date(drawdownDate).toLocaleDateString(language === "sv" ? "sv-SE" : "en-GB", { month: "short", year: "numeric" })}</span>
                        </span>
                      </div>
                    </div>
                  )}
